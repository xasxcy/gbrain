...
const HEALTHY_STATS = {
  ...
  getHealth: async () => ({
    ...
    entity_page_count: 10, brain_score: 95, dead_links: 0, link_coverage: 1, timeline_coverage: 1, most_connected: [],
  ...
  },
  {
    ...
    engine: {
      ...
      getHealth: async () => ({
        ...
        entity_page_count: 10, brain_score: 40, dead_links: 2, link_coverage: 0.2, timeline_coverage: 0.2, most_connected: [],
