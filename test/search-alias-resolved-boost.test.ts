...
describe('KNOBS_HASH_VERSION', () => {
  it('is 18 (15→16 detail fold #3515; 16→17 degradation-stamp epoch: pre-stamp cache rows become unreachable; 17→18 reranker document truncation invalidates prior rankings)', () => {
