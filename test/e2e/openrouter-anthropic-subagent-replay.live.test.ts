/**
 * LIVE e2e — OpenRouter Anthropic subagent abort/retry (TODOS.md v0.37.6.0).
 *
 * Skip-gated on OPENROUTER_API_KEY. First turn hits real OR Haiku, persists
...
describe('OpenRouter Anthropic live — abort mid-loop and resume', () => {
