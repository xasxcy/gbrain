...
//
// bump 17→18 (fork): reranker_max_document_chars changes the text scored by
// the cross-encoder, so cached rankings from a different truncation threshold
// must not be reused. The fork shipped this as v=16 before upstream's #3515
// and WP2/T3 waves claimed 16 and 17; per the same D8 sequencing convention
// it re-sequences to 18 here. Same one-time global cold-miss pattern.
